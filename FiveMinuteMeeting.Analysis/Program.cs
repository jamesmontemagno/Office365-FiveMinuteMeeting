...
namespace FiveMinuteMeeting.Analysis
{
	class Program
	{
			...
			var projects = new List<Solution> {
				...
				new Solution {
					...
					ProjectFiles = new List<string> {
						Path.Combine(path, "../FiveMinuteMeeting.Droid/FiveMinuteMeeting.Droid.csproj"),
						Path.Combine(path, "../FiveMinuteMeeting.Shared/FiveMinuteMeeting.Shared.projitems")
					},
				},
				...
				new Solution {
					Name = "iOS",
					ProjectFiles = new List<string> {
						Path.Combine(path, "../FiveMinuteMeeting.iOS/FiveMinuteMeeting.iOS.csproj"),
						Path.Combine(path, "../FiveMinuteMeeting.Shared/FiveMinuteMeeting.Shared.projitems")
					},
				},
			};
